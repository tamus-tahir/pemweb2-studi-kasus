...
<form class="row g-3 needs-validation" novalidate action="/navigasi/update/<?= $navigasi['id_navigasi']; ?>" method="post">

    <div class="col-md-6">
        <label for="navigasi" class="form-label">Navigasi <span class="text-danger">*</span></label>
        <input type="text" class="form-control <?= $validation->hasError('navigasi') ? 'is-invalid' : ''; ?>" id="navigasi" name="navigasi" required value="<?= $navigasi['navigasi']; ?>">
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control <?= $validation->hasError('url') ? 'is-invalid' : ''; ?>" id="url" name="url" required value="<?= $navigasi['url']; ?>">
        <div class="valid-feedback">Looks good!</div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" class="form-control <?= $validation->hasError('icon') ? 'is-invalid' : ''; ?>" id="icon" name="icon" required value="<?= $navigasi['icon']; ?>">
        <div class="valid-feedback">Looks good!</div>
        <div class="invalid-feedback"><?= $validation->getError('icon') ? $validation->getError('icon') : 'Please choose a icon.'; ?></div>
    </div>
    <div class="col-md-3">
        <label for="urutan" class="form-label">Urutan <span class="text-danger">*</span></label>
        <input type="number" class="form-control <?= $validation->hasError('urutan') ? 'is-invalid' : ''; ?>" id="urutan" name="urutan" required value="<?= $navigasi['urutan']; ?>">
        <div class="valid-feedback">Looks good!</div>
    ...
    <div class="col-md-3">
        ...
        <select class="form-select <?= $validation->hasError('aktif') ? 'is-invalid' : ''; ?>" id="aktif" name="aktif" required>
            <option value="Yes" <?= $navigasi['aktif'] == 'Yes' ? 'selected' : ''; ?>>Yes</option>
            <option value="No" <?= $navigasi['aktif'] == 'No' ? 'selected' : ''; ?>>No</option>
        </select>
        <div class="valid-feedback">Looks good!</div>
