...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2023 at 03:59 PM
...
(1, '2022-11-19-083355', 'App\\Database\\Migrations\\Config', 'default', 'App', 1674966531, 1),
(2, '2022-12-01-045904', 'App\\Database\\Migrations\\Navigasi', 'default', 'App', 1674966531, 1),
(3, '2022-12-07-081528', 'App\\Database\\Migrations\\Profil', 'default', 'App', 1674966531, 1),
(4, '2022-12-07-090635', 'App\\Database\\Migrations\\Akses', 'default', 'App', 1674966531, 1),
(5, '2022-12-11-180717', 'App\\Database\\Migrations\\User', 'default', 'App', 1674966531, 1),
(6, '2023-01-29-033134', 'App\\Database\\Migrations\\Prodi', 'default', 'App', 1674966531, 1);
...
(1, 1, 1, '2023-01-28 22:29:03', '2023-01-28 22:29:03'),
(2, 1, 2, '2023-01-28 22:29:03', '2023-01-28 22:29:03'),
(3, 1, 3, '2023-01-28 22:29:03', '2023-01-28 22:29:03'),
(4, 1, 4, '2023-01-28 22:29:03', '2023-01-28 22:29:03'),
(5, 1, 5, '2023-01-28 22:29:03', '2023-01-28 22:29:03');
...
(1, 'UserManager', '@ 2022 || Tamus D Tahir', 'logo.png', 'CI4, BS5', 'Tamus D Tahir', 'Aplikasi ini merupakan template user manager', '2023-01-28 22:29:03', '2023-01-28 22:29:03');
...
(1, 'Dashboard', 'dashboard', 'bi bi-grid', 1, 'Yes', '2023-01-28 22:29:03', '2023-01-28 22:29:03'),
(2, 'Config', 'config', 'bi bi-gear', 2, 'Yes', '2023-01-28 22:29:03', '2023-01-28 22:29:03'),
(3, 'Navigasi', 'navigasi', 'bi bi-sign-turn-right', 3, 'Yes', '2023-01-28 22:29:03', '2023-01-28 22:29:03'),
(4, 'Profil', 'profil', 'bi bi-person', 4, 'Yes', '2023-01-28 22:29:03', '2023-01-28 22:29:03'),
(5, 'User', 'user', 'bi bi-people', 5, 'Yes', '2023-01-28 22:29:03', '2023-01-28 22:29:03');
...
CREATE TABLE `tabel_prodi` (
  `id_prodi` int(5) UNSIGNED NOT NULL,
  `prodi` varchar(50) NOT NULL,
  `prodi_created_at` datetime DEFAULT NULL,
  `prodi_updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tabel_prodi` (`id_prodi`, `prodi`, `prodi_created_at`, `prodi_updated_at`) VALUES
(1, 'Sistem', '2023-01-28 23:14:31', '2023-01-28 23:14:31'),
(2, 'Teknik', '2023-01-28 23:14:31', '2023-01-28 23:14:31'),
(3, 'Teknologi', '2023-01-28 23:14:31', '2023-01-28 23:14:43'),
(4, 'Bisnis', '2023-01-28 23:14:31', '2023-01-28 23:14:31'),
(5, 'Pendidikan', '2023-01-28 23:14:31', '2023-01-28 23:14:37');
...
(1, 'Superadmin', '2023-01-28 22:29:03', '2023-01-28 22:29:03');
...
(1, 1, 'superadmin', '$2y$10$JGI47pNshMLzVAbah3WbJedGxRtkZGzp6qM63UFq0JBzGqcdXhYaC', 'Tamus Tahir', '0811-8888-888', 1, 'superadmin.jpg', '2023-01-28 22:29:03', '2023-01-28 22:29:03');
...
--
ALTER TABLE `tabel_prodi`
  MODIFY `id_prodi` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
